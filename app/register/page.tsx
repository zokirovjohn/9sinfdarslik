...
export default function RegisterPage() {
  ...
  const validateForm = () => {
    ...
    if (!agreeTerms) {
      newErrors.terms = "Davom etish uchun shartlarga rozilik bildiring"
      isValid = false
    }
            ...
            {isSuccess ? (
              <Card className="border-2 border-green-500 shadow-lg">
                <CardHeader className="space-y-1">
                  ...
                  <CardTitle className="text-2xl font-bold text-center">Ro'yxatdan o'tish muvaffaqiyatli!</CardTitle>
                  <CardDescription className="text-center">
                    Sizning hisobingiz yaratildi. Tizimga kirish sahifasiga yo'naltirilmoqdasiz...
                  </CardDescription>
                </CardHeader>
